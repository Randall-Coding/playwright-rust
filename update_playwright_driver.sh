...
wget https://playwright.azureedge.net/builds/driver/next/playwright-$(cat development/CLI_VERSION).zip -O __driver.zip || wget https://playwright.azureedge.net/builds/driver/playwright-$(cat development/CLI_VERSION).zip -O __driver.zip
